...
import com.henlinkeji.shenbian.SelectPositionActivity;
...
public class PoiSearchTask implements PoiSearch.OnPoiSearchListener ,LocationSource{

    private static PoiSearchTask mInstance;
    private SelectPositionActivity.PoiAdapter mAdapter;
    ...
    public PoiSearchTask setAdapter(SelectPositionActivity.PoiAdapter adapter){
