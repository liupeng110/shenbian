...
/**
 * Created by Miracler on 17/8/19.
 */

public class PermissionsActivity extends AutoLayoutActivity {
    ...
    private void showMissingPermissionDialog() {
        ShowDialog.showSelectPopup(this, R.string.help, "当前应用缺少必要权限导致无法使用。\n\n请点击\"设置\"-\"权限\"-打开所需权限。\n\n最后点击两次后退按钮，即可返回。", R.string.settings, R.string.cancel, new OperationCallback() {
            @Override
            public void execute() {
                startAppSettings();
            }
