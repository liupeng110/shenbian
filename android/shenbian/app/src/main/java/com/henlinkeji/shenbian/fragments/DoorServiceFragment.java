...
public class DoorServiceFragment extends Fragment {
    @BindView(R.id.door_service_map)
    MapView mMapView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_door_service, null);
