...
public class HttpUtils {
    ...
    public static void get(final Context context, String url, final HttpPostCallBackListener httpPostCallBackListener) {
        get(context, url, httpPostCallBackListener, true);
    }

    public static void get(final Context context, String url, final HttpPostCallBackListener httpPostCallBackListener, boolean isDialog) {
        init(context);
        if (isDialog) {
            if (loadingDialog == null) {
                loadingDialog = new SpotsDialog(context, "正在加载数据");
    ...
    public static void download(final Context context, String url, String destFileDir, String destFileName, final boolean isApp) {
        ...
        OkHttpUtils.get().url(url).build().execute(new FileCallBack(destFileDir, destFileName) {
            ...
            public void onResponse(File file, int id) {
                progressDialog.dismiss();
                ToastUtils.disPlayShort(context, "下载成功，正在打开");
                if (isApp) {
