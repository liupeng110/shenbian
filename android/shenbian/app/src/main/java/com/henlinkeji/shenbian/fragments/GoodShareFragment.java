...
public class GoodShareFragment extends Fragment {
    @BindView(R.id.good_share_map)
    MapView mMapView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_good_share, null);
